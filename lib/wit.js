...
const Wit = function(token, actions, logger) {
  ...
  this.runActions = (sessionId, message, context, cb, maxSteps, externalProcessing) => {
  ...
  this.interactive = (externalProcessing, initContext, maxSteps) => {
  ...
  this.startOverride = () => {
    console.log('actually pausing interaction');
    this.manualOverride = true;
  };

  this.stopOverride = () => {
    console.log('actually starting interaction (again)');
    this.manualOverride = false;
  };
